...
import com.ge.predix.solsvc.api.SeedDataAPI;
 ...
 */
@Component
public class SeedDataImpl implements SeedDataAPI {
	...
	private static Logger log = LoggerFactory.getLogger(SeedDataImpl.class);
	...
	public Response greetings() {
		return handleResult("Greetings from CXF Seed Rest Service " + new Date()); //$NON-NLS-1$
	}
